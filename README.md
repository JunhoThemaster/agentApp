...
- **요인분석 (Factor Analysis) 수행**
  ...
  -  다음으로 요인의 갯수 선정을 위해 eigen-value + Scree Plot으로 시각화 를 해보았습니다.
    ...
    - 약 **10 ~ 20개의 요인수**가 나오는걸 확인했습니다. **실제 300개 이상의 feature에서 10-20개의 요인만으로 상관구조를 다 설명 가능**하다 라고 결론 내렸습니다.
...
### 😅 아쉬웠던 점
- **즉각적인 정리**
  - 이번 프로젝트를 진행하면서 내용들을 즉각 정리했던 부분이 많이 아쉬웠어서 해당 내용들을 찾기가 번거로웠습니다.
    앞으로는 그때 그때 정리의 습관화가 필요하다 생각합니다.
- **라벨 경계 애매성**  
